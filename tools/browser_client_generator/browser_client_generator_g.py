...
class AutoGenBrowser(BaseAutoGen):
    ...
    def gen_table(self):
        for n in ["nav", "container", "notification", "page"]:
            self.create_file(f'{n}.js', self.get_code(f'{n}.code.js'))
...
def browser_code_gen():
    ...
    auto_gen = AutoGenBrowser(dir_name='browser_client', auto_gen_dir_name='auto_gen',
                              main_file_name="index", extension_name="html")
